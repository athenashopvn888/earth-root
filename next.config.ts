...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      {
        source: "/delivery",
        destination: "/weed-delivery-etobicoke",
        permanent: true,
      },
      ...
      },
      {
        ...
        destination: "/info/etobicoke-weed-dispensary",
        permanent: true,
      },
      {
        source: "/info/cheap-weed-york",
        destination: "/info/cheap-weed-etobicoke",
        permanent: true,
      },
      {
        source: "/info/native-cigarettes-york",
        destination: "/info/native-cigarettes-etobicoke",
        permanent: true,
      },
      {
        source: "/info/weed-store-near-brampton",
        destination: "/info/weed-store-near-dundas-st-w-islington-etobicoke",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: "/info/dispensary-near-me-etobicoke",
        permanent: true,
      },
