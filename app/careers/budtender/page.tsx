...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.earthrootcannabis.ca/careers/budtender",
  },
};
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with EarthRoot.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>EarthRoot Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              EarthRoot Cannabis is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Late-shift availability is a plus at EarthRoot</li>
            </ul>
          </div>
        </div>
      </section>
        ...
        <div className={styles.contentGrid}>
          ...
          <section id="application" className={styles.formPanel} aria-label="Budtender application form">
            <div className={styles.formIntro}>
              ...
              <p>
                This form sends your response to the shared Athena Store Applications sheet under ERC01.
              </p>
