...
const requiredFields = [
  ...
  { name: "WhyQLC", label: "Why you want to work at EarthRoot" },
...
export default function BudtenderApplicationForm() {
  ...
  return (
    <form className={styles.applicationForm} onSubmit={handleSubmit} noValidate>
      <input type="hidden" name="StoreKey" value="ERC01" />
      <input type="hidden" name="StoreName" value="EarthRoot Cannabis" />
      ...
      <div className={styles.formSection}>
        ...
        <label className={styles.field}>
          <span>Why do you want to work at EarthRoot Cannabis?</span>
      ...
      <div className={styles.formSection}>
        ...
        <fieldset className={styles.choiceGroup}>
          <legend>Can you reliably get to Dundas Street West for scheduled shifts?</legend>
