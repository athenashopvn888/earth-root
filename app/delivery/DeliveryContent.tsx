...
export default function DeliveryContent() {
  ...
  return <main className={styles.main}>
    ...
    <section className={`${styles.hero} ${styles.heroPlain}`}>
      <div><p>EarthRoot Cannabis</p><h1>Delivery Menu</h1><span>Browse the shared product catalog. The store confirms current availability and delivery details before an order is accepted.</span></div>
    </section>
