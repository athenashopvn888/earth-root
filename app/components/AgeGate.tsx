...
export default function AgeGate() {
  ...
  useEffect(() => {
    ...
    const verified = localStorage.getItem("ERC01_age_verified");
    if (verified !== "true") {
      setShow(true);
    }
  }, []);
  ...
  const handleVerify = () => {
    localStorage.setItem("ERC01_age_verified", "true");
    setShow(false);
  };
          ...
          <div className={styles.promptState}>
            <div className={styles.logoWrap}>
              <img
                ...
                alt="EarthRoot Cannabis"
                className={styles.logo}
              />
            </div>
            <h2 className={styles.title}>Age Verification</h2>
            <p className={styles.text}>
              EarthRoot Cannabis requires all visitors to be of legal age.
