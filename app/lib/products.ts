...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at EarthRoot Cannabis?", a: "Yes! Visit us at 5120 Dundas St W, Etobicoke. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
  ...
  "MAGIC & OTHERS": {
    ...
    seoDescription: "EarthRoot Cannabis carries a curated selection of magic mushrooms and specialty products in Etobicoke. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 5120 Dundas St W for our full selection.",
    faqs: [
