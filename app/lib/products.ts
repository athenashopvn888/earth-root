...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoIntro: "Browse edible options at EarthRoot Cannabis. Compare product names, package details, posted notes, and current menu information before choosing.",
    ...
    faqs: [
      { q: "What edibles are listed at EarthRoot Cannabis?", a: "Use the current menu to compare edible names, package details, prices, and item notes." },
  ...
  "VAPE PENS": {
    ...
    seoIntro: "Compare vape listings at EarthRoot Cannabis by product name, format, posted notes, and current menu details.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "Use the disposable vape category at EarthRoot Cannabis for current product names, formats, and menu notes.",
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Compare concentrates at EarthRoot Cannabis by product type, name, posted notes, and current menu details.",
  ...
  PREROLLS: {
    ...
    seoIntro: "Shop pre-rolls at EarthRoot Cannabis by comparing the current product name, format, package details, and posted notes.",
  ...
  "ADD ONS": {
    ...
    seoIntro: "Browse accessories at EarthRoot Cannabis and compare the current menu notes before visiting.",
