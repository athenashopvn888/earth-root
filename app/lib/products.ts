...
> = {
  EXOTIC: {
    ...
    color: "#f59e0b",
    icon: "\uD83D\uDD25",
    tagline: "Explore EarthRoot Cannabis's Exotic Weed flower tier",
...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles Etobicoke | EarthRoot Cannabis",
    seoIntro: "Browse edible options at EarthRoot Cannabis. Compare product names, package details, posted details, and current menu information before choosing.",
    seoDescription: "Edibles shop best when you compare the exact listing instead of guessing from an old example. Use the current menu at EarthRoot Cannabis for names, package details, posted prices, and staff help when needed.",
    faqs: [
      { q: "What edibles are listed at EarthRoot Cannabis?", a: "Use the current menu to compare edible names, package details, prices, and item details." },
  ...
  "VAPE PENS": {
    ...
    seoTitle: "Vapes Etobicoke | EarthRoot Cannabis",
    seoIntro: "Compare vape listings at EarthRoot Cannabis by product name, format, posted details, and current menu details.",
  ...
  "VAPE DISPOSABLE": {
    ...
    seoTitle: "Disposable Vapes Etobicoke | EarthRoot Cannabis",
    seoIntro: "Use the disposable vape category at EarthRoot Cannabis for current product names, formats, and menu details.",
  ...
  CONCENTRATES: {
    ...
    seoTitle: "Concentrates Etobicoke | EarthRoot Cannabis",
    seoIntro: "Compare concentrates at EarthRoot Cannabis by product type, name, posted details, and current menu details.",
  ...
  PREROLLS: {
    ...
    seoTitle: "Pre-Rolls Etobicoke | EarthRoot Cannabis",
    seoIntro: "Shop pre-rolls at EarthRoot Cannabis by comparing the current product name, format, package details, and posted details.",
  ...
  "ADD ONS": {
    ...
    seoTitle: "Cannabis Accessories Etobicoke | EarthRoot Cannabis",
    seoIntro: "Browse accessories at EarthRoot Cannabis and compare the current menu details before visiting.",
  ...
  "MAGIC & OTHERS": {
    ...
    seoTitle: "Specialty Items | EarthRoot Cannabis",
    seoIntro: "Browse specialty items only where they are listed on the current EarthRoot Cannabis menu.",
  ...
  CIGARETTES: {
    ...
    seoTitle: "Native Cigarettes Etobicoke | EarthRoot Cannabis",
    seoIntro: "Native smokes at EarthRoot Cannabis in Etobicoke. The cigarette menu may show $25 carton-style listings and brands such as Canadian Lights, Canadian Full, Putters, Canadian Goose Full, Canadian Goose Lights, Canadian Menthol, Canadian Classics Original, and Canadian Classics Silver.",
    seoDescription: "Use the cigarette category to compare current Native smoke listings at EarthRoot Cannabis. Specific brands, carton options, and prices can change, so check the current menu or ask staff before visiting.",
    faqs: [
      { q: "Does EarthRoot Cannabis list Native cigarettes?", a: "Check the cigarette category for current Native smoke listings and brand names." },
