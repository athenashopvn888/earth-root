...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    seoTitle: "Cannabis Edibles Menu in Etobicoke | EarthRoot Cannabis",
    seoIntro: "Browse edibles category information at EarthRoot Cannabis in Etobicoke. Review edible-related menu categories and confirm current menu details before visiting.",
    seoDescription: "EarthRoot Cannabis provides edibles category and menu information for shoppers in Etobicoke. Use this page to review edible-related menu categories and check current store details before visiting 5120 Dundas St W. Product selection can change, so confirm current menu information before you come in.",
    faqs: [
      ...
      { q: "Where can I review edibles information for EarthRoot Cannabis?", a: "Use the edibles category page for EarthRoot Cannabis in Etobicoke and confirm current details before visiting." },
    ],
  },
  "VAPE PENS": {
    banner: "/banners/01_Vape_Pens.webp",
    name: "THC Vape", slug: "vapes", color: "#8b5cf6", icon: "💨",
    seoTitle: "Vape Pens in Etobicoke | EarthRoot Cannabis",
    seoIntro: "Browse vape category information at EarthRoot Cannabis in Etobicoke. Review vape-related menu categories and confirm current menu details before visiting.",
    seoDescription: "EarthRoot Cannabis provides vape category and menu information for shoppers in Etobicoke. Use this page to review vape-related menu categories and check current store details before visiting 5120 Dundas St W. Product selection can change, so confirm current menu information before you come in.",
    faqs: [
      ...
      { q: "Where can I review vape category information for EarthRoot Cannabis?", a: "Use the vapes category page for EarthRoot Cannabis in Etobicoke and confirm current details before visiting." },
    ],
  },
  "VAPE DISPOSABLE": {
  ...
  "ADD ONS": {
    ...
    seoDescription: "EarthRoot Cannabis carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 5120 Dundas St W, Etobicoke.",
    faqs: [
  ...
  CIGARETTES: {
    ...
    faqs: [
      ...
      { q: "Are your cigarette prices competitive?", a: "Absolutely. We offer some of the best cigarette prices in the ByWard Market area of Etobicoke." },
    ],
  },
};
