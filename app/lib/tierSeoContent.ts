...
export const TIER_SEO: Record<string, TierSeoData> = {
  ...
  BUDGET: {
    ...
    seoIntro: "Cheap weed in Etobicoke starting at $3/g. EarthRoot Cannabis Budget tier features shreds and value ounces for cost-conscious smokers. Check current store hours before visiting EarthRoot Cannabis.",
    sections: [
      {
      ...
      },
      {
        ...
        body: "Budget flower starts at just $3 per gram. Value ounces start from $40 — some of the best prices you'll find in Etobicoke. Selected Budget flower may show value bundle pricing on the flower bundle menu.",
      },
    ],
    faqs: [
