...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about EarthRoot Cannabis in Etobicoke. Hours, location, products, pricing, bundle offers, and everything you need to know before visiting.",
  alternates: {
