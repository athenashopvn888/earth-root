...
export const RESOURCE_PAGES: ResourcePage[] = [
  {
    ...
    "description": "Resource guides for shopping the EarthRoot Cannabis menu in Etobicoke, including flower, value, pre-rolls, and Native smokes where listed.",
    "eyebrow": "Resource Centre",
    "intro": "Welcome to the EarthRoot Cannabis resource centre. This is the no-stress corner for shoppers who want the menu to make sense before they visit. Pick the product lane, compare what matters, then use the current menu or staff for details that change.",
    "cards": [
      {
        "title": "Menu Guide",
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": "EarthRoot Cannabis serves shoppers around Dundas St W / Islington / Etobicoke, Dundas St W, Islington, Six Points. If you searched for a weed dispensary in Dundas St W / Islington / Etobicoke, this resource section keeps the visit simple: right store, right menu lane, right next step."
      }
    ]
  },
  {
    ...
    "description": "How to shop the EarthRoot Cannabis menu by category, with natural tips for flower, pre-rolls, edibles, THC vapes, concentrates, and value shopping.",
    "eyebrow": "Menu Guide",
  ...
  },
  {
    ...
    "description": "Compare exotic flower, premium flower, budget weed, cheap weed, and affordable weed at EarthRoot Cannabis without guessing.",
  ...
  },
  {
    ...
    "description": "A practical value guide for shoppers comparing cheap weed, budget weed, affordable weed, and menu categories at EarthRoot Cannabis.",
    "eyebrow": "Value Guide",
  ...
  },
  {
    ...
    "seoTitle": "EarthRoot Cannabis Pre-Roll Guide | Etobicoke Cannabis Menu Tips",
    "description": "How to compare pre-rolls at EarthRoot Cannabis without mixing them up with flower, edibles, THC vapes, and concentrates.",
  ...
  },
  {
    ...
    "description": "The EarthRoot Cannabis resource centre gives shoppers cleaner menu guides for flower, value, pre-rolls, and store visits.",
  ...
  },
  {
    ...
    "seoTitle": "EarthRoot Cannabis Native Cigarettes Guide | Brands and Carton Notes",
    "description": "A shopper-friendly Native cigarettes guide for EarthRoot Cannabis, including brand names shown on the menu and $25 carton notes where listed.",
