...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "primaryKeyword": "weed dispensary in Etobicoke",
    "keywords": [
      "weed dispensary in Etobicoke",
      "cannabis store in Etobicoke",
      "Etobicoke weed store",
      "24 hour cannabis store",
      "weed store",
      "cannabis dispensary"
    ],
    "oldTitle": "EarthRoot Cannabis Menu Category Guide",
    "wordCount": 531,
    "businessReviewFlags": []
  },
  {
    ...
    "primaryKeyword": "flower menu Etobicoke",
    "keywords": [
      "weed dispensary in Etobicoke",
      "cannabis store in Etobicoke",
      "Etobicoke weed store",
    ...
    "oldTitle": "EarthRoot Cannabis Price and Flower Tier Guide",
    "wordCount": 548,
    "businessReviewFlags": []
  },
  {
    ...
    "primaryKeyword": "cannabis menu Etobicoke",
    "keywords": [
      "weed dispensary in Etobicoke",
      "cannabis store in Etobicoke",
      "Etobicoke weed store",
    ...
    "oldTitle": "EarthRoot Cannabis Local Visit Guide for Adults 19+",
    "wordCount": 529,
    "businessReviewFlags": []
  }
];
