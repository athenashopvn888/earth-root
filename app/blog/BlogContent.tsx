...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why EarthRoot Cannabis is Etobicoke's Best Dispensary",
...
/* ── Google Reviews ── */
const REVIEWS = [
  { name: "Mike R.", rating: 5, text: "Best dispensary in the Etobicoke area. Staff is super knowledgeable and the exotic strains are legit fire.", date: "2 weeks ago" },
