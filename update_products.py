"""
EarthRoot Cannabis — Product Update Script
===================================
Drop your ONHAND CSV into the earth-root folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  EarthRoot Cannabis — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://earthrootcannabis.ca")
    else:
